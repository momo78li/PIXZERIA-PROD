        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="p-6 rounded-2xl border" style={{ borderColor: '#E8E8E8' }}>
            ...
            <div className="text-sm leading-relaxed" style={{ color: '#5F6368' }}>
              <p>Diese Website wird bei <strong style={{ color: '#111' }}>Strato AG</strong> (Otto-Ostrowski-Straße 7, 10249 Berlin) gehostet. Beim Aufruf der Website werden automatisch Informationen in Server-Log-Dateien gespeichert:</p>
